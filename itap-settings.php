    ...
    public function itap_plugin_settings_page(){
        ...
        echo '<div id="itap_settings_form_wrapper">';
          ...
          echo '<div id="donate-itap">
            ...
            <input type="image" src="'. plugins_url(plugin_basename(__DIR__ .'/images/paypal.png') ).'" border="0" name="submit" alt="PayPal Ð The safer, easier way to pay online.">
